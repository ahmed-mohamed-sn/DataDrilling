package com.personal.datadrilling.config;
...
public class JHipsterProperties {
    ...
    public static class Mail {
        ...
        private String from = "DrillTheData@localhost";
    ...
    public static class Swagger {
        ...
        private String title = "DrillTheData API";

        private String description = "DrillTheData API documentation";
    ...
    public static class Metrics {
        ...
        public static class Graphite {
            ...
            private String prefix = "DrillTheData";
